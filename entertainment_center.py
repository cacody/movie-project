...
empire = media.Movie(
    ...
    "As dads go, yours was WAY better than his.")


pineapple = media.Movie(
    "Pineapple Express",
...
mystery_men = media.Movie(
    ...
    "Overlooked heroes can save the day.")
...
the_burbs = media.Movie(
    ...
    "Even in mediocrity, you can undermine evil freaks - you just need to flout a few property and utility laws.")
...
illusionist = media.Movie(
    ...
    "You can do a way better vaguely-European accent than Edward Norton. So bad.")

the_golden_child = media.Movie(
    "The Golden Child",
